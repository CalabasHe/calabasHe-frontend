		...
		<div className="fixed inset-0 bg-black bg-opacity-30 z-20 flex items-center justify-center">
			{submitStatus ? (
				<form className="bg-white w-[92%] md:w-[50%] shadow-md rounded-md z-30 py-3 relative flex flex-col" onSubmit={verifyCode} onKeyDown={handleKeyDown}>
					...
					<button className="bg-[#FEE330] disabled:bg-yellow-300 w-[65%] py-2 self-center text-lg font-semibold rounded-md disabled:cursor-not-allowed" type="submit" disabled={disabled}>Submit review</button>
				</form>
			) : (
				showPopUp && (
					<motion.div

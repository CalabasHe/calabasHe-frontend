        ...
        <section className="flex flex-col lg:flex-row gap-11 lg:justify-center w-full">
          ...
          {allResults.length > 0 ? (
            <div className=" w-full max-w-[900px]">
              ...
              {/* Results list */}
              <div className="justify-items-start flex flex-col mb-7 items-start gap-4 lg:gap-12">
                {facilities.length > 0 &&
                  facilities.map((result) => (
                    ...
                    >
                      <div className="w-full h-auto bg-white rounded-[8px] p-4 flex flex-col lg:flex-row gap-4 items-start">
                        ...
                        {result.logo ? 
                          <img className='object-cover size-24 rounded-[inherit]' src={result.logo} alt={`logo for ${result.name}`}/>
                          :

                          <img className='size-24' src={HospitalIcon} alt='default facility icon' />
                        }
                        ...
                        <Link to={`/facilities/${result.type}/${result.slug}`} className="flex-1">
                          ...
                          {/* Reviews count */}
                          <span className="text-[#6a6a67]  text-xs md:text-sm">
                    ...
                    {doctors.map((result) => (
                      ...
                      >
                        <div className="w-full h-auto bg-white rounded-[8px] p-4 flex flex-col lg:flex-row gap-4 items-start cursor-pointer">
                          {result.image ? 
                          <img className='object-cover size-24 rounded-[inherit]' src={result.image} alt={`image of doctor ${result.lastName}`}/>
                          :
            ...
            <div className="flex flex-grow items-center">
              <h2 className=" text-lg text-slate-400 w-full text-center font-semibold">
                No results found
              </h2>
            </div>
          )}

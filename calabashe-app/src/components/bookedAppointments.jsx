...
const BookedAppointments = () => {
    ...
    return (
        isLoading && !bookingData ? (
            ...
            <div className="w-full max-w-5xl mx-auto rounded-2xl border border-gray-100 bg-white shadow-sm">
                <div className="grid grid-cols-[auto_1fr_1fr_1fr_1fr] gap-4 items-center bg-gray-50 p-4">
                    <div className="w-5" />
                ...
                {bookingData.map((data, index) => {
                    ...
                    return (
                        <div key={index} className="grid grid-cols-[auto_1fr_1fr_1fr_1fr] gap-4 items-center p-4 border-t border-gray-100">
                            ...
                            <div className="text-gray-700 ml-5">{format(startTime, 'h:mm a')}</div>
                            <div className="text-gray-700 ml-5">{format(endTime, 'h:mm a')}</div>

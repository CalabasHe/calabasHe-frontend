        ...
        <section className="px-8 lg:px-[100px] pt-12 pb-6 flex lg:gap-3 xl:gap-8  items-center bg-white border-b">
          ...
          <div className="space-y-1">
            <div>
              ...
              <p className="text-sm lg:text-base font-light text-gray-600 ">{doctor.specialtyTag}</p>
            </div>
          ...
          <section className="w-[54%] flex flex-col gap-4">
            ...
            </section>
            {
              ...
              <section className="w-full space-y-3 px-1.5 border-t border-b py-5 my-4">
                ...
                <button onClick={() => showMore()} className={`${doctor.conditionsAndTreatments.length < sliceNum ? 'hidden' : ''} text-sm underline`}>Show more</button>
              </section>
              )
            }

    ...
    <>
      {doctors.map((doctor) => (
        <Link
          ...
          key={doctor.id}
          className="cursor-pointer lg:hover:scale-[1.01] duration-300 mt-4 border  bg-white shadow-md h-[165px] sm:h-36 md:h-40 lg:h-48 rounded-md md:rounded-xl w-[98%] max-w-[380px] md:w-[85%] md:max-w-[800px] sm:max-w-[600px] lg:w-full p-1 lg:px-4 flex gap-4 md:gap-6 min-[400px]:gap-6"
        >
          ...
          <div className="relative h-[full] mt-2 lg:self-center lg:h-[90%] w-[35%] max-w-[120px] sm:max-w-[150px] max-md:max-w-[180px] lg:w-[150px] flex items-center justify-center border rounded-md">
            ...
            <svg
              ...
              } absolute size-6 -top-2 -right-2 fill-current text-[#205CD4]`}
              xmlns="http://www.w3.org/2000/svg"
              id="Layer_1"
              data-name="Layer 1"
              viewBox="0 0 24 24"
          ...
          <section className="antialiased lg:self-center grow flex flex-col max-sm:max-w-[60%] sm:flex-row justify-between py-1">
            <div className="px-1 mb-auto overflow-hidden">
              <h2 className="text-xs md:text-base lg:text-base xl:text-lg font-black max-md:max-w-[250px] md:max-w-[280px] lg:max-w-[325px] xl:max-w-[350px] overflow-hidden text-ellipsis whitespace-nowrap">
      ...
      <div className="flex border-r border-black my-8 md:my-12">
        ...
        <button
          ...
          className={`${
            hasNextPage ? "flex border-r-0" : "hidden"

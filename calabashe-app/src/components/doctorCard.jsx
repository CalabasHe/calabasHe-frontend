...
const DoctorCard = () => {
  ...
  return ( 
    <>
      {doctors.map(doctor => (
        <div key={doctor.id} className="cursor-pointer bg-white lg:hover:scale-[1.05] duration-300 mt-4 border shadow-md h-28 sm:h-36 md:h-40 lg:h-44 rounded-md w-[98%] max-w-[380px] md:w-[70%] md:max-w-[600px] p-1 flex gap-4 min-[400px]:gap-6">

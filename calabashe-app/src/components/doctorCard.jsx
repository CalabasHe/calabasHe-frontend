...
const DoctorCard = () => {
  return ( 
    <>
      <div className="cursor-pointer bg-white hover:scale-[1.05] duration-300 mt-4 border shadow-md h-28 sm:h-36 md:h-40 lg:h-44 rounded-md w-[95%] max-w-[350px] md:w-[70%] md:max-w-[600px] p-1 flex gap-3 min-[400px]:gap-4">

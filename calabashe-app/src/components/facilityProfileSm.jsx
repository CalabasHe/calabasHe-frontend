      ...
      <main className="md:hidden w-full mt-8 sm:mt-[80px] pb-8 flex flex-col gap-8 items-center ">
        ...
        <section className="w-full px-2 pt-12 pb-6 flex gap-6  items-center bg-white border-b">
          ...
          <div className="w-full px-4">
            <Link to='/initial_form' state={{ message: [facility.name] }} 
            className={`${!facility.verified ? "flex" : "hidden"}  w-full px-[7%] py-3 flex items-center justify-between border-[#205CD4] border rounded-md`}>

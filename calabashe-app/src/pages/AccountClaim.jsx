...
const AccountClaim = () => {
  return ( 
    <>
    <div className="relative xl:container xl:mx-auto max-xl:min-w-screen lg:flex justify-between overflow-hidden">
    <svg className="hidden lg:flex absolute 2xl:-bottom-[200px] -bottom-[260px] 2xl:-left-[200px] -left-[300px]" width="431" height="365" viewBox="0 0 431 365" fill="none" xmlns="http://www.w3.org/2000/svg">

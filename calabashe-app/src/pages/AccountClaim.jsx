...
const AccountClaim = () => {
  return ( 
    ...
    <svg className="hidden lg:flex absolute xl:-bottom-[200px] -bottom-[260px] xl:-left-[200px] -left-[300px]" width="431" height="365" viewBox="0 0 431 365" fill="none" xmlns="http://www.w3.org/2000/svg">

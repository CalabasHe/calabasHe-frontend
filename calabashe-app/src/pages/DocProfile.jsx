      ...
      <Header/>
          ...
          <main className="w-full mt-12 sm:mt-[80px] lg:mt-[105px] px-4  pb-8 flex flex-col gap-12 items-center ">
            ...
            <section className="w-full space-y-3 md:w-[80%] md:max-w-[700px]">
              ...
              <p className="text-base">Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo, rem ex error nulla dolorem, deserunt maiores fugiat autem quasi non, saepe qui eligendi molestias laborum delectus aspernatur sunt. Consectetur, sit?</p>
            </section>
            <section className="w-full space-y-4 md:w-[80%] md:max-w-[700px]">
              ...
              <ul className="space-y-2">
                ...
                <li className="flex gap-3">
                  ...
                  <p className="text-base self-center font-medium">{doctor.location}, Ghana</p>
                </li>
              </ul>
            </section>
            ...
            <section className="w-full space-y-4 md:w-[80%] max-w-[700px]">
              ...
              <div className="bg-[#E8EDF1] py-12 px-4 md:px-8 rounded-lg space-y-6">
                <div className="space-y-2">
                  <span className="text-3xl md:text-4xl font-black">{doctor.rating}</span>
            ...
            <section className="w-full space-y-4 md:w-[80%] md:max-w-[700px]">
              ...
              {!doctor.reviews.length > 0 ? <p className="text-base text-[#A0AAB3]">No reviews yet</p> :
              <p  className="text-base text-[#A0AAB3]">All reviews have been left by actual patients.</p>}
            </section>


            <section className="w-full space-y-4 md:w-[80%] md:max-w-[700px]">
            <h3 className="text-xl font-bold ">Share your experience</h3>
            <p className="text-base font-medium max-w-[85%]">
            ...
            {/* Leave a Review */}
            <Link to={`/review/${slug}`} className="w-full md:w-[80%] md:max-w-[700px] lg:hover:scale-[1.01] duration-100">
                <button 
                  className="w-full flex justify-center gap-4 md:gap-8 p-4 bg-[#FEE330] rounded-xl"
                  aria-label={`Leave a review for Dr. ${doctor.slug}`}
                  >
                  <p className="text-center text-xl md:text-2xl font-bold">Leave a Review</p>

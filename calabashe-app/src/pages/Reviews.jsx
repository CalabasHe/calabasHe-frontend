      ...
      <Header/>
        ...
        <section className="p-4 px-2 md:px-12 lg:px-16 md:py-8 lg:py-12 md:border space-y-2 bg-white shadow-md border rounded-2xl w-full max-sm:max-w-[500px] md:w-[80%] md:max-w-[700px] ">
          <div className="w-full flex flex-col gap-2">
            ...
            <h2 className="md:text-left text-center text-lg font-semibold border-b-[1px] border-gray-400 pb-3 md:pb-6 lg:pb-8">Your review of {reviewee.type === 'doctor' ? 'Dr. ' + reviewee.name: reviewee.name}</h2>
            ...
            <form onSubmit={handleSubmit}  className="mt-2 md:mt-3 lg:mt-4 flex flex-col gap-4 md:gap-6 lg:gap-8">
              ...
              <div className="mt-2 space-y-3">
                <label className="text-base md:text-[20px] font-medium" htmlFor="review">Tell us more about your visit</label>

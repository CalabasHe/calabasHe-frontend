        ...
        <main className="px-4 mt-16 md:mt-24 pb-6 lg:pb-10 md:px-12 lg:px-16">
          ...
          <section className="mt-6 md:mt-10 space-y-4 md:space-y-8">
            ...
            {/* <div className="w-full md:flex md:justify-between"> */}
              ...
              <div className={`w-full ${doctors.length > 0 || facilities.length > 0 ? 'md:w-2/3' : ''} justify-self-end flex flex-col md:pl-4`}>
                  ...
                  <section className="flex flex-col  gap-6 lg:gap-8">
                    ...
                    <>
                      ...
                      <p className="font-semibold text-base md:text-lg">
                        ...
                        {doctors.map((doctor) => (
                          <div
                          className="w-full flex gap-2 md:gap-3 max-w-[450px] h-[120px] rounded-md border shadow-md px-2 py-2 bg-white"
                          key={doctor.id}
                        >
                          ...
                          <div className="space-y-2">
                            <div>
                              <Link to={`/doctors/${doctor.slug}`} className="font-bold text-base">
                      ...
                      <div className="space-y-3">
                        {facilities.map((facility) => (
                          ...
                          >
                            ...
                            <div className="space-y-2">
                              <div>
                                <Link to={`/facilities/${facility.facility_type.name.toLowerCase()}s/${facility.slug}`} className="font-bold text-base">
                                  {facility.name}
                                </Link>
                                <p className="text-sm font-light">

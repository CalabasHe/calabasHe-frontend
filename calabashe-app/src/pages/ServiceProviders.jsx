        ...
        <main className="px-4 mt-16 md:mt-24 mb-1 md:px-12 lg:px-16">
          ...
          <section className="mt-6 md:mt-10 space-y-4 md:space-y-8">
            ...
            <div className="w-full md:flex md:justify-between">
              <div>
              <p className={`${doctors.length > 0 || facilities.length > 0  && ('md:flex')} hidden text-base font-medium`}>
                  Filter Results
                </p>
              </div>
              <div className={`w-full ${doctors.length > 0 || facilities.length > 0  && ('md:w-2/3')} justify-self-end flex flex-col `}>

...
const Services = () => {
  return ( 
    <>
      ...
      <FadeInOut>
            <div className="z-0 absolute top-[60px] sm:top-[70px] md:[] w-[25%]  bg-[#04DA8D] h-16 max-w-[110px] sm:max-w-[180px] sm:h-24" ></div>
      ...
      <AnimatePage>
        ...
        <main className="w-full mt-16 md:mt-24 flex justify-center px-2 sm:px-3 pb-4 sm:pb-8">
          <ServiceLink/>
        </main>
      </AnimatePage>
      {/* <Footer/> */}

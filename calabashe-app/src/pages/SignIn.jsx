      ...
      <main className="bg-[#04DA8D] min-h-screen py-4 pt-[15%] lg:pt-0 flex items-center justify-center text-white">
        <AnimatePage>
          <div className="relative z-50 bg-[#1E4738] w-[90vw] sm:w-[80vw] max-w-[300px] sm:max-w-[350px] md:min-w-[40vw] lg:min-w-[30vw] md:max-w-[400px] flex flex-col grow pointer-events-auto rounded-md py-6 pt-8 lg:py-8 p-4 px-[3%]">
            ...
            <form className=" font-medium space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col gap-5">
                <div className="space-y-1">
                  ...
                  <input
                    className="border-0 text-base lg:p-2 placeholder:text-xs  text-black p-1 px-2  rounded-md w-full"
                ...
                <div className="space-y-1">
                  <label className="block text-sm" htmlFor="passwd">
                    Password
                  </label>
                  <div className="relative flex">
                    ...
                    <button
                      className={` ${
                        passwordHidden ? "fill-green-600" : "fill-red-500"
              ...
              <div className="flex flex-col gap-y-2">
                ...
                <Link
                  className="w-[fit-content] self-center text-sm font-medium  lg:text-base text-center mt-2 text-blue-500 hover:underline"
                  to="/sign_up"

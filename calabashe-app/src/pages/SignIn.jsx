...
const SignIn = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(error.response.data || "Account doesn't exist");
    } finally {
  ...
  return ( 
    <>
      <div className="flex flex-col h-[100vh] px-2 sm:px-4 lg:px-[5%] py-3">
      <header className="font-bold text-xl lg:text-3xl mb-4" >
        <Link to='/home'> Calabas<span className="text-[#04DA8D]">He</span> </Link>
      </header>     
      
      <AnimatePage>
        <main className="flex-grow flex items-center justify-center">
          
          <div className="w-[90%] sm:w-[80%] max-w-[350px] sm:max-w-[400px] flex flex-col grow border-2 border-black pointer-events-auto rounded-md py-4 lg:py-6 p-4 px-[3%]">
            ...
            <form className=" font-semibold space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col gap-y-2" >
                ...
                <Link className="text-xs  lg:text-sm text-center mt-2 text-blue-500 hover:underline" to='/sign_up'>Don&apos;t have an account? Sign Up</Link>
              </div>
            </form>

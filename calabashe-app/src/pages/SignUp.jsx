    ...
    <div className="overflow-x-hidden relative bg-[#04DA8D] flex flex-col h-[100vh] py-3">
      ...
      <div className="z-10 flex flex-col flex-grow px-1 sm:px-3 lg:px-5% mt-[50px] md:mt-0">
        ...
        <main className="flex-grow flex items-center justify-center">
          ...
          <div className="bg-white w-[90%] sm:w-[80%] max-w-[350px] sm:max-w-[400px] flex flex-col grow border-black pointer-events-auto rounded-md py-4 lg:py-6 p-4 px-[3%]">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div>
                  ...
                  <div className="relative flex h-full">
                    ...
                    <button 
                      className="hidden cursor-pointer fill-green-600 w-8 h-[100%] absolute right-1 flex items-center justify-center"
                      id="hidePassword"

...
const SignUp = () => {
  ...
  return (
    <div className=" 2xl:container 2xl:mx-auto overflow-y-auto bg-[#04DA8D] h-screen w-screen flex items-center justify-center pt-8 ">
      <AnimateY>
        ...
        <main className=" h-[100%] w-full flex items-center justify-center">
          <div className="relative z-20 bg-white w-[90%] sm:w-[80%] max-w-[300px] sm:max-w-[350px] md:min-w-[40vw] md:max-w-[550px]  flex flex-col  border-black pointer-events-auto rounded-md py-4 lg:py-6 p-4 px-[3%]">
            ...
            <div className="absolute  left-[18%] w-[180px] sm:w-[210px] md:w-[240px] -top-[100px] sm:-top-[120px] md:hidden  md:-top-[150px] lg:hidden z-10">
              <picture className="relative z-0 inset-0 object-fill">
                <source
                  ...
                  srcSet={docs1}
                  type="image/webp"
                  alt="animated picture of doctors posing"
                ></source>
                <img
                  className="z-0 object-fill"
                  src={docs1png}
            ...
            <form
              ...
              className="font-semibold space-y-6 cursor-auto"
            >
              ...
              <div className="flex flex-col gap-4">
                <div>
                  ...
                  <input
                    className="text-base leading-3 p-1 px-2  rounded-md w-full"
                    type="email"
                    id="email"
                ...
                <div>
                  ...
                  <div className="relative flex h-full">
                    <input
                      className="leading-3 text-base p-1 px-2 rounded-md w-full"
                      type="password"
                      id="passwd"
                    ...
                    <button
                      ...
                      className={`${
                        passwdHidden ? "fill-green-600" : "fill-red-500"
                      }  cursor-pointer w-8 h-[100%] absolute right-1 flex items-center justify-center`}
                      tabIndex="-1"
              ...
              <div className="flex flex-col gap-y-2">
                ...
                <Link
                  className="text-sm  lg:text-base font-semibold text-center mt-2 text-blue-700 hover:underline"
